function sensors(num) {
  ...
  document.getElementById("val2").innerHTML = num[1];
  document.getElementById("val3").innerHTML = num[2];
  document.getElementById("val4").innerHTML = num[3];
  document.getElementById("val5").innerHTML = num[4];
  document.getElementById("val6").innerHTML = num[5];
  document.getElementById("val7").innerHTML = num[6];
  document.getElementById("val8").innerHTML = num[7];
}
